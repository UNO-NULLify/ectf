...
module UART_v2_50_1 (
    ...
    defparam BUART.BreakBitsRX = 14;
    defparam BUART.BreakBitsTX = 14;
...
module top ;
    ...
    UART_v2_50_1 CARD_UART (
        ...
        .rx_data(Net_31),
        .rx_clk(Net_32));
    defparam CARD_UART.Address1 = 0;
    defparam CARD_UART.Address2 = 0;
    defparam CARD_UART.EnIntRXInterrupt = 1;
    defparam CARD_UART.EnIntTXInterrupt = 1;
    defparam CARD_UART.FlowControl = 0;
    defparam CARD_UART.HalfDuplexEn = 0;
    defparam CARD_UART.HwTXEnSignal = 1;
    defparam CARD_UART.NumDataBits = 8;
    defparam CARD_UART.NumStopBits = 1;
    defparam CARD_UART.ParityType = 0;
    defparam CARD_UART.RXEnable = 1;
    defparam CARD_UART.TXEnable = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("a4f11828-71f6-4968-ba44-6110c0412857"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
