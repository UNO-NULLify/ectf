...
#define SW1_SW1			(SW1__SW1__PC)
#define SW1_SW1_PS		(SW1__SW1__PS)
#define SW1_SW1_PC		(SW1__SW1__PC)
#define SW1_SW1_DR		(SW1__SW1__DR)
#define SW1_SW1_SHIFT	(SW1__SW1__SHIFT)
#define SW1_SW1_INTR	((uint16)((uint16)0x0003u << (SW1__0__SHIFT*2u)))
