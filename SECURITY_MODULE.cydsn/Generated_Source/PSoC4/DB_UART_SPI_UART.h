...
#define DB_UART_SPI_INTR_RX_MASK           (0u)
#define DB_UART_SPI_INTR_TX_MASK           (0u)
...
#define DB_UART_UART_MP_RX_ADDRESS         (2u)
#define DB_UART_UART_MP_RX_ADDRESS_MASK    (255u)

#define DB_UART_UART_INTERRUPT_MODE        (1u)

#define DB_UART_UART_INTR_RX_MASK          (4u)
#define DB_UART_UART_INTR_TX_MASK          (0u)
