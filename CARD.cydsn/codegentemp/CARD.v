...
module top ;
    ...
    UART_v2_50_0 ATM_UART (
        ...
        .rx_data(Net_35),
        .rx_clk(Net_36));
    defparam ATM_UART.Address1 = 0;
    defparam ATM_UART.Address2 = 0;
    defparam ATM_UART.EnIntRXInterrupt = 1;
    defparam ATM_UART.EnIntTXInterrupt = 1;
    defparam ATM_UART.FlowControl = 0;
    defparam ATM_UART.HalfDuplexEn = 0;
    defparam ATM_UART.HwTXEnSignal = 1;
    defparam ATM_UART.NumDataBits = 8;
    defparam ATM_UART.NumStopBits = 1;
    defparam ATM_UART.ParityType = 0;
    defparam ATM_UART.RXEnable = 1;
    defparam ATM_UART.TXEnable = 1;
